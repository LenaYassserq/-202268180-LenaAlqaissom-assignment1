...
### Description
This project is a responsive single-page portfolio website developed as part of an academic assignment. The purpose of the website is to demonstrate foundational web development skills using HTML, CSS, and JavaScript.

The website presents personal information, selected academic projects, and contact details in a clean and structured layout.

---

## 2. Technologies Used

- **HTML5** – Structured semantic layout for content organization.
- **CSS3** – Styling, layout design, and responsive behavior using Flexbox.
- **JavaScript (Vanilla JS)** – Basic interactivity and dynamic functionality.
